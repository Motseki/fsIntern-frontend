...
// const WalletDepositAuth_success = () => {
//   return (
//     <div>WalletDepositAuth_success</div>
//   )
// }
...
function WalletWithdrawAuth_success({ display }){
  return (
    <body>
        <header>
            <Auth_nav />
                ...
                <div className="cnt">
                    <div className="fl1">
                            <div className="success">
                                ...
                                <p className="p1">Withdrawal successful!</p>
                                <p className="p2">You’ve been credited successfully!</p>
                                <Link to='/wallet_index' className='a a1'>Awesome!</Link>
...
export default WalletWithdrawAuth_success