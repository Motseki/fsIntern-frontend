...
function WalletWithdrawPaymentMethod({ display, onclick, backclick }) {
  ...
  return (
    <form action="" className="frm Idi" style={{ display }}>
      <p className="t1">Means of acceptance</p>
      <p className="t2">How do you intend receiving the payment?</p>
      ...
      <div className="qs">
        ...
        <span className="qs crypto_div">
            <span className="spq">
                <span className="sp sp2">
                    <Account_info_crd img={btc_img} acct_name={'Peter Williams'} acct_no={'hhhhhhhhhhhhhhhhhhhh'} acct_currency={'NGN'} />
                </span>
            </span>
...
export default WalletWithdrawPaymentMethod;
