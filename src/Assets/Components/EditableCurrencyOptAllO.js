...
import './EditableCurrencyOptAllO.css'
...
const EditableCurrencyOptAllO = (props) => {
  ...
  return (
    ...
    <div className="curr_opt">
      <div className="curr">
            ...
            <input type="number" name="fname" placeholder={props.placeholder} className='in'/>
...
export default EditableCurrencyOptAllO;
